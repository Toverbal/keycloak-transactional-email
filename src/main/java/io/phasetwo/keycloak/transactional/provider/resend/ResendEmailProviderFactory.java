package io.phasetwo.keycloak.transactional.provider.resend;
...
public class ResendEmailProviderFactory implements TransactionalEmailProviderFactory {

  public static final String PROVIDER_ID = "resend";

  @Override
  public TransactionalEmailProvider create(KeycloakSession session) {
    return new ResendEmailProvider(session);
  }
